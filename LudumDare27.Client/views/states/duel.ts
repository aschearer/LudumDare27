...
module views.states {
    ...
    export class Duel implements IState {
        ...
        private lessButton: HTMLAnchorElement;
        ...
        public enter(previousState: IState) {
            ...
            var tutor = <HTMLElement>this.layer.getElementsByClassName('tutor')[0];
        ...
        private activateInstruction(activeInstruction: number) {
            ...
            if (activeInstruction >= this.instructions.children.length) {
                ...
                this.lessButton = <HTMLAnchorElement>this.activeInstruction.getElementsByClassName('less-button')[0];
                if (this.lessButton) {
                    this.lessButton.onclick = () => {
                        this.hideInstructions();
                        return false;
                    };
                }
